...
ui <-
  pageWithSidebar(
    ...
    sidebarPanel(
      ...
      HTML('(via a <a href="https://bookdown.org/max/FES/numeric-one-to-one.html" target="_blank">Yeo-Johnson transformation</a>)'),
      tags$br(),
      checkboxInput(inputId = "nzv", label = "Remove Near Zero-Variance Columns", TRUE),
      HTML('(<a href="https://topepo.github.io/caret/pre-processing.html#zero--and-near-zero-variance-predictors" target="_blank">details</a>)')
    ),
    # sidebarPanel
    mainPanel(
      HTML('<a href="https://bookdown.org/max/FES/numeric-many-to-many.html" target="_blank">Principal Component Analysis</a>'),
      plotOutput("pca"),
      tags$hr(),
